...
public class Socio
{
    ...
    /**
     * Aumenta los fondos disponibles del socio. <br>
     * <b>pre: </b> Los fondos han sido inicializados. <br>
     ...
     * @throws Exception Si el monto excede el máximo permitido según el tipo de socio.
     */
    ...
    /**
     * Registra un nuevo consumo para el socio, realizado por él mismo o por una de sus
     ...
     * @throws Exception Si el socio no tiene fondos suficientes para el consumo.
     */
     ...
     * @throws Exception Si el nombre es el mismo del socio, si no tiene fondos o si el autorizado ya existe.
     */
     ...
     * @throws Exception Si el autorizado tiene una factura sin pagar.
     */
