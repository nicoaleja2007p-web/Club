...
public class Factura
{
    ...
    /**
     * Retorna el nombre que realizó el consumo que generó la factura. <br>
     ...
     * @return Una cadena de caracteres con la información de la factura con el siguiente
     * formato <concepto> $<valor> (<nombre>).
     */
